...
Create Table Equipment(
	...
	RoomRoomNumber Integer NOT NULL,
	FOREIGN KEY (RoomRoomNumber) REFERENCES Room(RoomNumber),
...
Create Table RoomServices(
	...
	FOREIGN KEY (RoomRoomNumber) REFERENCES Room(RoomNumber),
	Constraint pkRoomServices Primary Key (RoomRoomNumber, Services));
...
Create Table RoomAccess(
	...
	Constraint pkRoomAccess Primary Key (RoomRoomNumber, EmployeeEmployeeID));

/* Examines */
Create Table Examines(
	DoctorDoctorID Integer NOT NULL,
	AdmissionAdminID Integer NOT NULL,
	Result VARCHAR(300),
	Constraint pkExamines Primary Key (DoctorDoctorID, AdmissionAdminID),
	FOREIGN KEY (DoctorDoctorID) REFERENCES Doctor(DoctorID),
...
Create Table StaysIn(
	...
	Constraint pkStaysIn Primary Key (AdmissionAdminID, RoomRoomNumber, StartDate),
	FOREIGN KEY (AdmissionAdminID) REFERENCES Admission(AdminID),
	FOREIGN KEY (RoomRoomNumber) REFERENCES Room(RoomNumber));
...
/* Room Service */
INSERT INTO RoomServices(RoomRoomNumber,Services) VALUES(1000,'MRI');
INSERT INTO RoomServices(RoomRoomNumber,Services) VALUES(1000,'MRI');
INSERT INTO RoomServices(RoomRoomNumber,Services) VALUES(1002,'Surgery');
INSERT INTO RoomServices(RoomRoomNumber,Services) VALUES(1002,'Surgery');
INSERT INTO RoomServices(RoomRoomNumber,Services) VALUES(1005,'X-ray');
INSERT INTO RoomServices(RoomRoomNumber,Services) VALUES(1005,'X-ray');

/* Equipment Type */
INSERT INTO EquipmentType(TypeID,Description,OperationalInstructions,Model) VALUES('10','Precision Knife','Use to make precision cuts.','A01', 1);
INSERT INTO EquipmentType(TypeID,Description,OperationalInstructions,Model) VALUES('11','Latex Gloves','Use to put on hands','A02', 2);
INSERT INTO EquipmentType(TypeID,Description,OperationalInstructions,Model) VALUES('12','Surgical Scissors','Use to cut body parts.','A03', 5);

/* Equipment */
INSERT INTO Equipment(SerialNumber,LastInspection, YearofPurchase, EquipmentTypeID, RoomRoomNumber) VALUES('A01-02X',TO_DATE('2010/10/29 18:06:34', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2005', 'yyyy'),10, 1000);
INSERT INTO Equipment(SerialNumber,LastInspection, YearofPurchase, EquipmentTypeID, RoomRoomNumber) VALUES('A01-03X',TO_DATE('2010/10/30 21:04:34', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2010', 'yyyy'),10, 1001);
INSERT INTO Equipment(SerialNumber,LastInspection, YearofPurchase, EquipmentTypeID, RoomRoomNumber) VALUES('A01-04X',TO_DATE('2010/11/09 20:04:34', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2003', 'yyyy'),10, 1002);
INSERT INTO Equipment(SerialNumber,LastInspection, YearofPurchase, EquipmentTypeID, RoomRoomNumber) VALUES('A01-05X',TO_DATE('2015/10/31 08:04:34', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2011', 'yyyy'),11, 1003);
INSERT INTO Equipment(SerialNumber,LastInspection, YearofPurchase, EquipmentTypeID, RoomRoomNumber) VALUES('A01-06X',TO_DATE('2010/11/30 18:34:34', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2010', 'yyyy'),11, 1004);
INSERT INTO Equipment(SerialNumber,LastInspection, YearofPurchase, EquipmentTypeID, RoomRoomNumber) VALUES('A01-07X',TO_DATE('2017/12/29 18:04:44', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2011', 'yyyy'),11, 1005);
INSERT INTO Equipment(SerialNumber,LastInspection, YearofPurchase, EquipmentTypeID, RoomRoomNumber) VALUES('A01-08X',TO_DATE('2009/10/29 18:04:35', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2004', 'yyyy'),12, 1006);
INSERT INTO Equipment(SerialNumber,LastInspection, YearofPurchase, EquipmentTypeID, RoomRoomNumber) VALUES('A01-09X',TO_DATE('2008/11/29 18:05:34', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2002', 'yyyy'),12, 1007);
INSERT INTO Equipment(SerialNumber,LastInspection, YearofPurchase, EquipmentTypeID, RoomRoomNumber) VALUES('A01-10X',TO_DATE('2008/10/30 19:04:34', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2001', 'yyyy'),12, 1008);
...
/* Room Access */
INSERT INTO RoomAccess(RoomRoomNumber,EmployeeEmployeeID) VALUES(1000,10000);
INSERT INTO RoomAccess(RoomRoomNumber,EmployeeEmployeeID) VALUES(1001,10001);
INSERT INTO RoomAccess(RoomRoomNumber,EmployeeEmployeeID) VALUES(1002,10002);

/* Examine */
INSERT INTO Examines(DoctorDoctorID,AdmissionAdminID,Result) VALUES(100,1,'Sprained Ankle');
INSERT INTO Examines(DoctorDoctorID,AdmissionAdminID,Result) VALUES(101,2,'Pneumonia');
INSERT INTO Examines(DoctorDoctorID,AdmissionAdminID,Result) VALUES(102,3,'Chest Pain');
INSERT INTO Examines(DoctorDoctorID,AdmissionAdminID,Result) VALUES(103,4,'Lung Cancer');
INSERT INTO Examines(DoctorDoctorID,AdmissionAdminID,Result) VALUES(104,5,'Testicular Cancer');

/* Stays In */
INSERT INTO StaysIn(AdmissionAdminID,RoomRoomNumber,StartDate,EndDate) VALUES (1,1000,TO_DATE('2010/10/29 19:05:35', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2010/10/29 19:25:25', 'yyyy/mm/dd hh24:mi:ss'));
INSERT INTO StaysIn(AdmissionAdminID,RoomRoomNumber,StartDate,EndDate) VALUES (2,1001,TO_DATE('2010/10/29 19:15:35', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2010/10/29 20:25:25', 'yyyy/mm/dd hh24:mi:ss'));
INSERT INTO StaysIn(AdmissionAdminID,RoomRoomNumber,StartDate,EndDate) VALUES (3,1002,TO_DATE('2010/10/29 19:25:35', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2010/10/29 20:25:25', 'yyyy/mm/dd hh24:mi:ss'));
INSERT INTO StaysIn(AdmissionAdminID,RoomRoomNumber,StartDate,EndDate) VALUES (4,1003,TO_DATE('2010/10/29 19:35:35', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2010/10/29 20:25:25', 'yyyy/mm/dd hh24:mi:ss'));
INSERT INTO StaysIn(AdmissionAdminID,RoomRoomNumber,StartDate,EndDate) VALUES (5,1004,TO_DATE('2010/10/29 19:45:35', 'yyyy/mm/dd hh24:mi:ss'),TO_DATE('2010/10/29 20:15:25', 'yyyy/mm/dd hh24:mi:ss'));
...
/* Q6 Report the employee who has access to the largest number of rooms. We need the employee ID, and the number of rooms he can access */
Select EmployeeEmployeeID, Max(Room)
From
    (Select EmployeeEmployeeID, Count(RoomRoomNumber) AS Room
    From RoomAccess
...
SELECT EmployeePosition, COUNT(EmployeePosition) as Count
FROM Employee
...
SELECT DoctorDoctorID, count(DoctorDoctorID) as ExaminationCount
FROM Examines , Admission
WHERE Admission.PatientSSN = '111-22-3333' 
    AND Examines.AdmissionAdminID = AdmissionAdminID
GROUP BY DoctorDoctorID HAVING count(DoctorDoctorID) > 2;

/* Q12 Report the equipment types for which the hospital has purchased  */
Select EquipmentTypeID
From Equipment
Where YearofPurchase= TO_DATE('2010', 'yyyy')
Intersect
    (Select EquipmentTypeID
    From Equipment
    Where YearofPurchase= TO_DATE('2011', 'yyyy'));
